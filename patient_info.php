        ...
        <script src="js/index.js"></script>
					...
					<div class="all_ad">
							...
							<tr>
								...
								<td>EMPLOYER NAME:</td>
								<td><input type="text" name="emp_name" placeholder="EMPLOYER NAME" style="height: 25px;width:230px;"></td>
							</tr>
							<tr>
								<td>EMPLOYER PHONE:</td>
								<td><input type="text" name="emp_phone" placeholder="EMPLOYER PHONE" style="height: 25px;width:230px;"></td>
							</tr>
							<tr>
						
								<td>EMPLOYER ADDRESS:</td>
								<td><input type="text" name="emp_address" style="height: 25px;width:230px;"></td>
							</tr>
							<tr>
								<td>AGE:</td>
									<td><input type="text" name="emp_age" placeholder="age" style="height: 25px;width:230px;"></td>
							</tr>
							<td><h2>SEAT FOR PATIANTT</h2></td>
					
							<tr>
								<td>Category</td>
								<td style="height: 25px;width:230px;">
									<input type="radio" name="set_Category" value="VIP" checked> VIP<br>
									<input type="radio" name="set_Category" value="AC">AC<br>
									<input type="radio" name="set_Category" value="NORMAL"> NORMAL<br><br>
								</td>
							</tr>
							<tr>
								<td>Appointment Time:</td>
								<td><input type="time" name="set_usr_time" style="height: 25px;width:230px;"></td>
							</tr>
							<tr>
								<td>FOLOR NO:</td>
											<td >
							...
							<tr>
								...
								<tr>
										<td>SEAT NO:</td>
										<td >
											<select name="set_no" style="height: 25px;width:230px;">
				...
				<div class="copyright">
				<center>
				&copy;Copyright 2018 (Red hat group-IUBAT)
				</center>
				</div>
			</div>
	</body>
